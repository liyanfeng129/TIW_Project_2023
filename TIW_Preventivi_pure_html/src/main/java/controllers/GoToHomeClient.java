...
/**
 * Servlet implementation class GoToHomeClient
 */
...
public class GoToHomeClient extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Preventive> listPreventive; 
		List<Product> listProduct;
		try {
			listPreventive = clientDao.getPreventivesByUserId();
		...
		request.setAttribute("listPreventive", listPreventive);
		request.setAttribute("listProduct", listProduct);
		
		forward(request, response, PathUtil.pathToHomeClientPage);
	}
